                  ...
                  <div className="flex flex-col md:flex-shrink-0  justify-start items-start">
                    ...
                    <div className="flex flex-row justify-start  space-x-4 md:space-x-6 items-start mt-4 ">
                      <p className="text-sm leading-none text-gray-600">
                        Adet: <span className="text-gray-800"> {item.quantity}</span>
                      </p>
                    </div>
                  </div>
            ...
            <div className="flex flex-col space-y-4 w-full">
              <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                <div className="flex justify-between  w-full">
                  <p className="text-base leading-4 text-gray-800">Alt Toplam</p>
                  <p className="text-base leading-4 text-gray-600">TRY {order?.amount?.toLocaleString("tr-TR")}</p>
                </div>
                <div className="flex justify-between  w-full">
